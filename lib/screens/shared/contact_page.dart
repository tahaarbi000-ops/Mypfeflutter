...
class _ContactPageState extends State<ContactPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
          title: const Text('Contact & Assistance'),
          ...
          children: [
              ...
              child: Padding(
                ...
                child: Column(
                  children: [
                    ...
                    _contactItem(Icons.email, 'support@TuniMove.tn', 'Email'),
                    _contactItem(Icons.location_on,
                        'Avenue Habib Bourguiba, Tunis', 'Adresse'),
                    _contactItem(Icons.access_time, 'Lun-Sam: 07h00 - 20h00',
                        'Horaires'),
                  ],
                ),
              ),
                ...
                child: _sent
                    ? Column(
                        children: [
                          ...
                          const Text('Nous vous répondrons dans les 24h',
                          ...
                          children: [
                            ...
                            DropdownButtonFormField<String>(
                              ...
                              items: const [
                                DropdownMenuItem(
                                    value: 'information',
                                    child: Text('Demande d\'information')),
                                DropdownMenuItem(
                                    value: 'reclamation',
            ...
            Card(
              child: ExpansionTile(
                ...
                children: [
                  _faqItem('Comment annuler mon billet ?',
                      'Contactez-nous au moins 2h avant le départ pour un remboursement.'),
                  _faqItem('Puis-je changer de trajet ?',
                      'Oui, sous réserve de disponibilité, 24h avant le départ.'),
                  _faqItem('Le QR code est-il sécurisé ?',
                      'Oui, chaque QR code est unique et ne peut être utilisé qu\'une seule fois.'),
                ],
              ),
            ),
          ],
